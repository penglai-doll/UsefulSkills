...
| [`decoding.file-container`](file-container.md) | best-effort | `magic`, `zip`, `pdf`, `pe`, `elf` | 输出可能是文件或归档时。 |
| [`decoding.symmetric`](symmetric.md) | best-effort | `aes`, `cbc`, `ecb`, `gcm` | sidecar/profile 指定 AES key/mode/IV/nonce/tag 时。 |
