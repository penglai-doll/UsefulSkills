...
This repository is a collection of custom-designed AI skills (for Codex, OpenAI Codex, etc.). Each skill lives in its own subdirectory with a standardized structure.
